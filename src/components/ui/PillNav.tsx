...
const PillNav = ({
  ...
  const [isSizDropdownOpen, setIsSizDropdownOpen] = useState(false);
      ...
      >
        ...
        <div className="pill-nav-items desktop-only" ref={navItemsRef}>
          <ul className="pill-list">
            {items.map((item, i) => (
              <li key={item.href || `item-${i}`} className="relative">
                {item.label === "Siz" ? (
                  // Special handling for Siz button with dropdown
                  ...
                  // Regular pill buttons for other items
