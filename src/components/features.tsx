...
const Features = () => {
  ...
  return (
    <section
      id="features"
      className="py-8 md:py-24 px-4 sm:px-6 md:px-margin-desktop max-w-container-max mx-auto bg-surface-elevated/45 dark:bg-surface-elevated/30 border-y border-border-subtle"
    >
