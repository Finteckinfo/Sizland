    ...
    return (
      <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl p-6 border border-gray-700/50 text-center">
        <div className="text-red-400 mb-4">
          ...
          <h3 className="text-lg font-semibold">Failed to Load Twitter Feed</h3>
        </div>
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-4 sm:gap-3">
        <div className="flex items-center gap-3 text-center sm:text-left">
          ...
          <div>
            <h3 className="text-lg sm:text-xl font-bold text-white">Latest from @{username}</h3>
            <p className="text-xs sm:text-sm text-gray-400">Stay updated with our latest news and updates</p>
          </div>
        </div>
      ...
      {isLoading && (
        <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl p-8 border border-gray-700/50 text-center">
          ...
          <p className="text-gray-400">Loading Twitter feed...</p>
        </div>
      )}
      ...
      {tweetId && !isLoading && (
        <div className="bg-gray-800/30 backdrop-blur-sm rounded-xl p-4 sm:p-6 border border-gray-700/30">
          <h4 className="text-base sm:text-lg font-semibold text-white mb-4 flex items-center justify-center sm:justify-start gap-2">
