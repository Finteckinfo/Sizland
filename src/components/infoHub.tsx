...
const InfoHub = () => {
    return (
        ...
        <div id="features" className="mx-auto max-w-6xl">
            ...
            <li className="bg-white/30 backdrop-blur-sm px-6 py-8 shadow-md dark:bg-green-400">
                <img
                src="https://www.svgrepo.com/show/530438/ddos-protection.svg"
                alt="DDOS Protection Icon"
                className="mx-auto h-10 w-10"
                />
                <h3 className="my-3 font-display font-medium dark:text-green-100">Sizland News</h3>
                <p className="mt-1.5 text-sm leading-6 text-gray-600 dark:text-green-100">
            ...
            <li className="bg-white/30 backdrop-blur-sm px-6 py-8 shadow-md dark:bg-green-400">
                ...
                className="mx-auto h-10 w-10"
                />
                <h3 className="my-3 font-display font-medium dark:text-green-100">Sizland Announcements</h3>
                <p className="mt-1.5 text-sm leading-6 text-gray-600 dark:text-green-100">
            ...
            <li className="bg-white/30 backdrop-blur-sm px-6 py-8 shadow-md dark:bg-green-400">
                ...
                className="mx-auto h-10 w-10"
                />
                <h3 className="my-3 font-display font-medium dark:text-green-100">Sizland Education</h3>
                <p className="mt-1.5 text-sm leading-6 text-gray-600 dark:text-green-100">
